...
<body>
    ...
    <div class="relative flex flex-col justify-center">
        <form method="post" action="login" class="w-full px-8 mx-auto mt-32 lg:w-96">        
            <#if referrer??>
            ...
            <h1 class="text-2xl font-bold text-center underline uppercase underline-offset-4">Accedi</h1>
            ...
            <button class="block px-8 py-2 mx-auto my-8 text-xl font-bold text-white uppercase bg-gray-900 rounded-xl" type="submit">login</button>
            <small>Non hai ancora un account?</small>
            <a class="underline underline-offset-4" href="./registration">Registrati</a>
        </form>
    </div>
