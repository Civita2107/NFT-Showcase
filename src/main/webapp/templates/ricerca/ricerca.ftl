...
<div class="w-full min-h-screen p-2 h-fit">
  <div class="relative flex items-center w-full">
    ...
    <div class="ml-4">
      ...
      <select id="filtro" name="filtro" value="tutto" class="w-auto bg-transparent focus:outline-none">
    ...
    <input type="text" placeholder="Cerca qui" name="keyword" class="w-full py-2 pl-2 pr-10 border-gray-300 rounded-md focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none">
