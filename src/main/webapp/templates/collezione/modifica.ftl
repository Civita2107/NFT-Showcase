<div class="relative flex flex-col justify-center">
    <form method="post" action="modifica-collezione?id=${collection.getKey()}">
        ...
        <#if collection.isPubblica()>
            <input id="pubblica" class="block w-full px-4 py-2 my-1 text-base border border-b-2 border-gray-500 rounded-md border-b-black" type="checkbox" name="pubblica" value="pubblica" checked>
            <#else>
                    ...
                    <div class="flex flex-col m-2 border shadow-lg rounded-2xl">
                        ...
                        <h2 class="flex flex-col p-2">
                            ...
                            <#if nft.getCollection()??>
                                <input type="checkbox" class="block w-full px-4 py-2 my-1 text-base border border-b-2 border-gray-500 rounded-md border-b-black" name="nfts" value="${nft.getKey()}" checked>
                                <#else>
