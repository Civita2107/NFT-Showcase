package it.univaq.disim.webengineering.nftsite.framework.controller;
...
import it.univaq.disim.webengineering.nftsite.framework.result.FailureResult;
...
public abstract class AbstractBaseController extends HttpServlet {
    ...
    protected abstract void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, TemplateManagerException, IOException, DataException;
